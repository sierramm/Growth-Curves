...
# plot lag time
ggplot(data_0712_sum, aes(x=ATC_uM, y=lag_time, color = ATC_uM)) +
  geom_point() +
...
ggplot(data_0712_sum, aes(x=ATC_uM, y=max_growth_rate, color = ATC_uM)) +
  geom_point() +
  facet_grid(rows = vars(Vector), cols = vars(Guide),
             labeller = labeller(Guide = guide_labs)) +
  theme_bw() +
...
ggplot(data_0712_sum, aes(x=ATC_uM, y=area_under_curve, color = ATC_uM)) +
  geom_point() +
  facet_grid(rows = vars(Vector), cols = vars(Guide),
             labeller = labeller(Guide = guide_labs)) +
  theme_bw() +
