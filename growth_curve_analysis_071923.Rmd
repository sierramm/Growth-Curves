...
guide_labs <- c("Guide 14 (NGG)", "Guide 15 (NAN)", "Guide 16 (NNN)", "Guide 17 (NGG)",
                ...
                "Guide 22 (NNN)", "Guide 23 (NGG)", "Guide 24 (NAN)", "Guide 25 (NNN)")
...
# plot lag time
lagtime_plot_0718 <- ggplot(data_0718_sum, aes(x=ATC_uM, y=lag_time, color = ATC_uM)) +
  geom_point() +
...
ggsave("071823_lagTimePlot.png", plot = lagtime_plot_0718)

# plot max growth rate
maxgrowthrate_plot_0718 <- ggplot(data_0718_sum, aes(x=ATC_uM, y=max_growth_rate, color = ATC_uM)) +
  geom_point() +
  facet_grid(rows = vars(Gene), cols = vars(Vector, PAM),
             labeller = labeller(Guide = guide_labs)) +
  theme_bw() +
...
ggsave("071823_maxGrowthRatePlot.png", plot = maxgrowthrate_plot_0718)

# plot area under curve
auc_plot_0718 <- ggplot(data_0718_sum, aes(x=ATC_uM, y=area_under_curve, color = ATC_uM)) +
  geom_point() +
  facet_grid(rows = vars(Gene), cols = vars(Vector, PAM),
             labeller = labeller(Guide = guide_labs)) +
  theme_bw() +
...
ggsave("071823_areaUnderCurvePlot.png", plot = auc_plot_0718)
```
