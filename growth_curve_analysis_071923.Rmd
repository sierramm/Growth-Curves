...
wide_data_0718_dnaA <- read_wides("") # data from plate 1
wide_data_0718_fusA <- read_wides("") # data from plate 2
wide_data_0718_proS <- read_wides("") # data from plate 3
wide_data_0718_ftsB <- read_wides("") # data from plate 4
