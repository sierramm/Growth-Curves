...
wide_data_0807 <- read_wides("081023_gc_data.csv") # data from plate 1
...
design_0810 <- make_design(
  output_format = "blocks", # set to "blocks" to check that it's correct, then save as "tidy"
  ...
  Vector = list(
    ...
    2:7,
    1:12,
    paste(c(rep("ABABAB", 9), rep("AAABBB", 18)), collapse = ""),
    FALSE
