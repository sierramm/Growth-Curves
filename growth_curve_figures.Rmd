...
data_0803 <- rbind(data_design_0803_plate1,
  ...
  filter(Gene %in% c("empty") | Guide == "26" | Guide == "13")
...
ggsave("ftsZ_plot.png", plot = ftsZ_plot, height=8, width = 14)
...
all_genes_plots <- ggarrange(fusA_plot, ftsB_plot, nrow =1, ncol = 2, common.legend = T, legend = "bottom")

ggsave("essential_genes_plot.jpg", plot = all_genes_plots, dpi = 700, height = 8, width = 16)
```
...
GuideFinder_boxplot_1 <- ggplot(data = GuideFinder_stats, aes(x=PAM, y = percent_genes, fill = parameters)) +
  geom_boxplot() +
  theme_bw() +
  scale_fill_manual(values = my_colors_1[c(2,1)]) +
  labs(x = "PAM Site", y = "Proportion of Genes with Guides") +
...
ggsave("GuideFinder_boxplot.jpg", plot = GuideFinder_boxplot_1, dpi = 700, height = 8, width = 8)
...
ggsave("guidefinder_comparison_plot.png", plot = strain_guidefinder_plot, dpi = 700, height = 8, width = 16)
...
ggsave(file = "Genes_noPAMless.jpg", plot = noPamlessGuidesPlot, dpi = 700, height = 8, width = 14)
